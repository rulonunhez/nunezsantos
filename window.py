...
"")
        ...
        self.btnGrabaCli.setGeometry(QtCore.QRect(360, 240, 75, 23))
        self.btnGrabaCli.setObjectName("btnGrabaCli")
        self.btnCalendar = QtWidgets.QPushButton(self.tabClientes_2)
        self.btnCalendar.setGeometry(QtCore.QRect(810, 30, 41, 23))
...
"")
        ...
        self.btnModifCli.setGeometry(QtCore.QRect(440, 240, 75, 23))
        self.btnModifCli.setObjectName("btnModifCli")
        self.btnBajaCli = QtWidgets.QPushButton(self.tabClientes_2)
        self.btnBajaCli.setGeometry(QtCore.QRect(520, 240, 75, 23))
        ...
        self.horizontalLayoutWidget_6.setGeometry(QtCore.QRect(100, 120, 751, 22))
...
"")
        ...
        self.lblMuni = QtWidgets.QLabel(self.horizontalLayoutWidget_6)
...
"")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(180, 180, 81, 42))
        ...
        self.lblEnvio.setGeometry(QtCore.QRect(480, 180, 81, 20))
        self.lblEnvio.setStyleSheet("color: rgb(255, 0, 0)")
        self.lblEnvio.setObjectName("lblEnvio")
        self.btnImprimirCli = QtWidgets.QPushButton(self.tabClientes_2)
...
"")
        ...
        self.btnPDFFac = QtWidgets.QPushButton(self.frame)
        self.btnPDFFac.setGeometry(QtCore.QRect(420, 60, 51, 31))
        self.btnPDFFac.setText("")
        self.btnPDFFac.setIcon(icon2)
        self.btnPDFFac.setIconSize(QtCore.QSize(38, 28))
        self.btnPDFFac.setObjectName("btnPDFFac")
        self.btnBorraVenta = QtWidgets.QPushButton(self.frame)
        self.btnBorraVenta.setGeometry(QtCore.QRect(860, 60, 51, 31))
        self.btnBorraVenta.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/newPrefix/papelera.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnBorraVenta.setIcon(icon5)
        self.btnBorraVenta.setIconSize(QtCore.QSize(23, 23))
        self.btnBorraVenta.setObjectName("btnBorraVenta")
        self.btnLimpiarFac = QtWidgets.QPushButton(self.frame)
        self.btnLimpiarFac.setGeometry(QtCore.QRect(800, 60, 51, 31))
        self.btnLimpiarFac.setText("")
        self.btnLimpiarFac.setIcon(icon1)
        self.btnLimpiarFac.setIconSize(QtCore.QSize(27, 24))
        ...
        self.tabFacturas.setGeometry(QtCore.QRect(20, 160, 201, 591))
        ...
        self.tabVentas.setGeometry(QtCore.QRect(230, 190, 721, 411))
        self.tabVentas.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.tabVentas.verticalHeader().setDefaultSectionSize(40)
        self.label_4 = QtWidgets.QLabel(self.tabFacturacion)
        self.label_4.setGeometry(QtCore.QRect(516, 160, 91, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lbl1 = QtWidgets.QLabel(self.tabFacturacion)
        self.lbl1.setGeometry(QtCore.QRect(710, 620, 91, 21))
        self.lbl1.setStyleSheet("background-color:rgb(255, 255, 180)")
        self.lbl1.setObjectName("lbl1")
        self.lbl2 = QtWidgets.QLabel(self.tabFacturacion)
        self.lbl2.setGeometry(QtCore.QRect(710, 650, 91, 21))
        self.lbl2.setStyleSheet("background-color:rgb(255, 255, 180)")
        self.lbl2.setObjectName("lbl2")
        self.lbl3 = QtWidgets.QLabel(self.tabFacturacion)
        self.lbl3.setGeometry(QtCore.QRect(710, 680, 91, 21))
        self.lbl3.setStyleSheet("background-color:rgb(255, 255, 180)")
        self.lbl3.setObjectName("lbl3")
        self.lblSubtotal = QtWidgets.QLabel(self.tabFacturacion)
        self.lblSubtotal.setGeometry(QtCore.QRect(810, 620, 141, 21))
        self.lblSubtotal.setStyleSheet("background-color:rgb(255, 193, 172)")
        self.lblSubtotal.setText("")
        self.lblSubtotal.setObjectName("lblSubtotal")
        self.lblIva = QtWidgets.QLabel(self.tabFacturacion)
        self.lblIva.setGeometry(QtCore.QRect(810, 650, 141, 21))
        self.lblIva.setStyleSheet("background-color:rgb(255, 193, 172)")
        self.lblIva.setText("")
        self.lblIva.setObjectName("lblIva")
        self.lblTotal = QtWidgets.QLabel(self.tabFacturacion)
        self.lblTotal.setGeometry(QtCore.QRect(810, 680, 141, 21))
        self.lblTotal.setStyleSheet("background-color:rgb(255, 193, 172)")
        self.lblTotal.setText("")
        self.lblTotal.setObjectName("lblTotal")
        self.lblVentaRealizada = QtWidgets.QLabel(self.tabFacturacion)
        self.lblVentaRealizada.setGeometry(QtCore.QRect(240, 620, 381, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.lblVentaRealizada.setFont(font)
        self.lblVentaRealizada.setText("")
        self.lblVentaRealizada.setObjectName("lblVentaRealizada")
...
"")
        ...
        self.lblResulCodigo.setAutoFillBackground(False)
        self.lblResulCodigo.setStyleSheet("background-color:rgb(255, 255, 180)")
        ...
        self.btnBuscarArt = QtWidgets.QPushButton(self.tabArticulos)
        self.btnBuscarArt.setGeometry(QtCore.QRect(630, 60, 51, 36))
        self.btnBuscarArt.setText("")
        self.btnBuscarArt.setIcon(icon4)
        self.btnBuscarArt.setIconSize(QtCore.QSize(30, 30))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/newPrefix/abrir_directorio.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbarAbrirDirectorio.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/newPrefix/crear.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbarCrearBackup.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/newPrefix/crearbackup.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbarRestaurarBackup.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/newPrefix/salir.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblApellidos_2.setText(_translate("MainWindow", "Forma de envío:"))
        self.lblApellidos_3.setText(_translate("MainWindow", "Restablecer datos"))
        ...
        self.label_4.setText(_translate("MainWindow", "VENTAS"))

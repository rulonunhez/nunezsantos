...
"")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../Downloads/unnamed.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbarAbrirDirectorio.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../.designer/backup/img/crear.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbarCrearBackup.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../.designer/backup/img/restaurarBackup.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbarRestaurarBackup.setIcon(icon3)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../../.designer/backup/img/impresora.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbarImpresora.setIcon(icon5)
